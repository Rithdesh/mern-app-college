...
const Navbar = () => {
  ...
  return (
    <nav className="bg-indigo-600 shadow-md px-6 py-4 flex flex-col gap-3 items-center justify-between text-white hover:bg-indigo-500 ">
      ...
      <ul className="flex items-center gap-10">
        ...
        <li>
          <Link
            to="/"
            className="text-ehite font-medium hover:text-yellow-300 hover:bg-white p-2 rounded transition duration-300"
          >
            Login
          </Link>
        </li>
